                        ...
                        <form method="POST" action="{{ route('products.update', $product->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('nama') is-invalid @enderror" id="nama" type="text"
                                    value="{{ old('nama') ? old('nama') : $product->nama }}"
                                    placeholder="Masukan Product" name="nama" autocomplete="off">
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('harga') is-invalid @enderror" id="harga" type="text"
                                    ...
                                    placeholder="Masukan Harga" name="harga" autocomplete="off">
                                @error('harga')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-control @error('status') is-invalid @enderror"
                                    id="status">
                                    <option value="{{ old('status') ? old('status') : $product->status }}" hidden="">
                                        {{ old('status') ? old('status') : $product->status }}
                                    </option>
